...
* **WoWSims CLI-Integration:** Das Skript `wowsims-cli.ps1` lädt die Windows-CLI herunter und führt dynamische Simulationen mit echten APL-Klassen-Rotationen und 25-Mann-Raidbuffs im Hintergrund aus.
